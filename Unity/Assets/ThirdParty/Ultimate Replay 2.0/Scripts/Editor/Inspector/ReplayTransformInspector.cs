        ...
        public void DisplayMultiElementField(string label, bool skipLocal, ref bool[] x, ref bool[] y, ref bool[] z, ref bool[] local, ref bool[] interpolate, ref bool[] lowRes)
        {
            ...
            GUILayout.BeginHorizontal();
            {
                ...
                else
                {
                    ...
                    DisplayMultiEditableToggleOnly(ref x, GUILayout.Width(elementToggleWidth));
                    ...
                    DisplayMultiEditableToggleOnly(ref y, GUILayout.Width(elementToggleWidth));
                    ...
                    DisplayMultiEditableToggleOnly(ref z, GUILayout.Width(elementToggleWidth));
                }
                ...
                if (skipLocal == false)
                {
                    ...
                    DisplayMultiEditableToggleOnly(ref local, GUILayout.Width(elementToggleWidth));
                }
                else
                {
                ...
                DisplayMultiEditableToggleOnly(ref interpolate, GUILayout.Width(elementToggleWidth));
                ...
                DisplayMultiEditableToggleOnly(ref lowRes, GUILayout.Width(elementToggleWidth));
            }
            GUILayout.EndHorizontal();
        }
