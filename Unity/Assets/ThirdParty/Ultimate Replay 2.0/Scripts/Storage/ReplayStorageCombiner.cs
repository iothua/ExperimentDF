...
namespace UltimateReplay.Storage
{
    public class ReplayStorageCombiner
    {
        ...
        public void AddAndCombineSnapshot(ReplaySnapshot newCombineSnapshot)
        {
            ...
            CombineSnapshot(newCombineSnapshot);
        ...
        public void CombineSnapshot(ReplaySnapshot combineSnapshot)
        {
            ...
            foreach(ReplayIdentity identity in combineSnapshot.Identities)
            {
                ...
                if(storable.StorageType == ReplaySnapshotStorableType.StateStorage)
                {
                    ...
                    // Combine the data
                    storable = GetCombinedSnapshotDataForObject(identity, stateData);
                }
        ...
        private IReplaySnapshotStorable GetCombinedSnapshotDataForObject(ReplayIdentity identity, ReplayState stateData)
        {
            ...
            int overridePointer = GetLastStateWithMatchingDataForObject(identity, stateData.DataHash);
