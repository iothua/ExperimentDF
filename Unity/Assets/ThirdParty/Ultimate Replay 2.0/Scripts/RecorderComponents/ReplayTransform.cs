...
#pragma warning restore 0414
        ...
        public override void OnReplaySerialize(ReplayState state)
        {
            ...
            // Update elements
            sharedSerializer.Position = ((StorageFlags & ReplayTransformSerializer.ReplayTransformSerializeFlags.LocalPos) != 0) ? thisTransform.localPosition : thisTransform.position;
            sharedSerializer.Rotation = ((StorageFlags & ReplayTransformSerializer.ReplayTransformSerializeFlags.LocalRot) != 0) ? thisTransform.localRotation : thisTransform.rotation;
            sharedSerializer.Scale = thisTransform.localScale;
        ...
        private void UpdatePosition(ReplayTime time, ReplayTransformSerializer.ReplayTransformSerializeFlags flags, bool interpolate)
        {
            ...
            if((flags & ReplayTransformSerializer.ReplayTransformSerializeFlags.LocalPos) != 0)
            {
                ...
                float x = ((flags & ReplayTransformSerializer.ReplayTransformSerializeFlags.PosX) != 0) ? updatePosition.x : transform.localPosition.x;
                float y = ((flags & ReplayTransformSerializer.ReplayTransformSerializeFlags.PosY) != 0) ? updatePosition.y : transform.localPosition.y;
                float z = ((flags & ReplayTransformSerializer.ReplayTransformSerializeFlags.PosZ) != 0) ? updatePosition.z : transform.localPosition.z;
            ...
            {
                // Get update values for selected axis
                float x = ((flags & ReplayTransformSerializer.ReplayTransformSerializeFlags.PosX) != 0) ? updatePosition.x : transform.position.x;
                float y = ((flags & ReplayTransformSerializer.ReplayTransformSerializeFlags.PosY) != 0) ? updatePosition.y : transform.position.y;
                float z = ((flags & ReplayTransformSerializer.ReplayTransformSerializeFlags.PosZ) != 0) ? updatePosition.z : transform.position.z;
        ...
        private void UpdateRotation(ReplayTime time, ReplayTransformSerializer.ReplayTransformSerializeFlags flags, bool interoplate)
        {
            ...
            if((flags & ReplayTransformSerializer.ReplayTransformSerializeFlags.LocalRot) != 0)
            {
                if ((flags & ReplayTransformSerializer.ReplayTransformSerializeFlags.RotX) != 0 || (flags & ReplayTransformSerializer.ReplayTransformSerializeFlags.RotY) != 0 || (flags & ReplayTransformSerializer.ReplayTransformSerializeFlags.RotZ) != 0)
                {
                    ...
                    transform.localRotation = updateRotation;
                }
                else
                {
                    ...
                    float x = ((flags & ReplayTransformSerializer.ReplayTransformSerializeFlags.RotX) != 0) ? updateRotation.x : transform.localEulerAngles.x;
                    float y = ((flags & ReplayTransformSerializer.ReplayTransformSerializeFlags.RotY) != 0) ? updateRotation.y : transform.localEulerAngles.y;
                    float z = ((flags & ReplayTransformSerializer.ReplayTransformSerializeFlags.RotZ) != 0) ? updateRotation.z : transform.localEulerAngles.z;
        ...
        private void UpdateScale(ReplayTime time, ReplayTransformSerializer.ReplayTransformSerializeFlags flags, bool interoplate)
        {
            ...
            // Get update values for selected axis
            float x = ((flags & ReplayTransformSerializer.ReplayTransformSerializeFlags.ScaX) != 0) ? updateScale.x : transform.localScale.x;
            float y = ((flags & ReplayTransformSerializer.ReplayTransformSerializeFlags.ScaY) != 0) ? updateScale.y : transform.localScale.y;
            float z = ((flags & ReplayTransformSerializer.ReplayTransformSerializeFlags.ScaZ) != 0) ? updateScale.z : transform.localScale.z;
