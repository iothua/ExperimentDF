...
namespace UltimateReplay
{
    ...
    public abstract class ReplayBehaviour : MonoBehaviour
    {
        ...
        {
            SafeInvokeReplayEvent(behaviours, (b) => b.OnReplaySpawned(position, rotation));
        }
